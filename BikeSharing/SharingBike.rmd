...
```{r}
#Q1 scatterplot, version 1 code
scatterplot(registered~as.factor(workingday), data = datasetBike,
            xlab = "Workingday",
            ylab = "Number of Bikes Rented",
            main = "Scatter plot with Regression Line")
abline(model1, col = "red", lwd = 2)

#Q1 scatterplot, version 2 code
...
ggplot(new_data, aes(x = workingday, y = predicted_registered, fill = weather)) +
  ...
  facet_wrap(~yr) +
  labs(x = "Working Day", y = "Predicted Number of Bikes Registered", title = "Predicted Bike Registrations") +
  theme_minimal()
...
new_data$predicted_registered <- predict(model1, newdata = new_data)
ggplot(new_data, aes(x = interaction(workingday, yr), y = predicted_registered, fill = weather)) +
  geom_bar(stat = "identity", position = position_dodge()) +
  labs(x = "Working Day and Year", y = "Predicted Number of Bikes Registered", 
       title = "Predicted Bike Registrations by Working Day and Year") +
  theme_minimal() +
...
#Q1 How does workingday affect the number of registered users? 
...
#Q2 How does season affect the number of casual users?
...
#Q3 Is weather correlated to the number of bike rentals?
