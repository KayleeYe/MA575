...
plot(combinedData$instant, combinedData$cnt,  # Adjust 'cnt' if it's in a different data structure
     xlab = "Instant",
     ylab = "Number of Bikes Rented",
     main = "Scatter Plot of Number of Bikes Rented vs. Instant",
...
plot(fitted(model_wind), res_wind, main="Fitted vs Residuals Plot for Wind", xlab="Fitted Values", ylab="Residuals")
abline(0,0)
