...
full_model1 <- lm(registered ~ workingday + weathersit,
                 data = training_data)

full_model2 <- lm( sqrt(casual)~ workingday + season + weathersit,
                 data = training_data)

full_model3 <- lm( cnt ~ workingday+ temp + hum + windspeed + weathersit,
                 data = training_data)
